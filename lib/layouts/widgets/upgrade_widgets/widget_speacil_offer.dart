...
class WidgetSpeacilOffer extends StatelessWidget {
  final bool secondOffer;
  final UpgradePlanModel plan;

  const WidgetSpeacilOffer({
    super.key,
    required this.secondOffer,
    required this.plan,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: secondOffer ? null : LinearGradient(
          colors: [AppColors.grad1Color, AppColors.grad2Color],
        ),
        color: secondOffer ? AppColors.purple : null,
